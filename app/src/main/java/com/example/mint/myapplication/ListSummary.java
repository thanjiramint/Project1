...
public class ListSummary extends ActionBarActivity implements AdapterView.OnItemClickListener ,AdapterView.OnItemLongClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.rawQuery(
                "SELECT _id, topic , ( 'Date :' || datew ) g from course;",
                null);
      ...
      public void onItemClick(AdapterView<?> parent, View view,
          ...
          int ids = view.getId();
          Intent i;
          i = new Intent(this, summaryselected.class);
          startActivity(i);
      }
